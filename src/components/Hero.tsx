    ...
    <section className='flex items-center justify-between mt-[3rem]'>
      ...
      <div className='flex-1 xl:w-3/5'>
        ...
        <div className='flex gap-6'>
          <FaTwitter className='text-[1.3rem] text-subtextColor cursor-pointer transition-all delay-[0.3s] hover:text-[1.4rem] hover:text-iconHover' />
          <FaInstagram className='text-[1.3rem] text-subtextColor cursor-pointer transition-all delay-[0.3s] hover:text-[1.4rem] hover:text-iconHover' />
          <FaGithub className='text-[1.3rem] text-subtextColor cursor-pointer transition-all delay-[0.3s] hover:text-[1.4rem] hover:text-iconHover' />
